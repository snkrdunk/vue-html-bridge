...
| —    | External-adapter specifier/PnP; sandboxing; client launcher packaging; trust granularity — confirm with the user before deciding, not just before shipping; the tradeoffs aren't concrete enough yet to pre-judge                                                                                                                                                                                                                                                                                                                                           | Phase 3                                                                    |
